...
class DecoratorTagLibTests extends GroovyPagesTestCase {
    ...
    void testMarkdown() {
        assert applyTemplate('<g:decorate include="markdown">The quick brown **fox** jumps over the lazy **dog**.</g:decorate>') == "<p>The quick brown <strong>fox</strong> jumps over the lazy <strong>dog</strong>.</p>"
    }
}
